...
class IntegerIndividualSpawningPool(ListIndividualSpawningPool):
    ...
    def __init__(self, size, fitness, lower, upper):
        ...
        :param size: The size of the individuals to be created from this
            spawning pool.
        :param fitness: The fitness to evaluate the individuals.
...
class IntegerRangeRecombination(FixedLengthListRecombination):
